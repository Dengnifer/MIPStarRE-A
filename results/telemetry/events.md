...
### 2026-09-09 - PR487 failed refresh conflict recovery

- Session `orc-485-20260909-03` resumes the ordinary merge left by lane485 at
  09:28:27Z. Its immutable branch parent is
  `cdd5699b7ced274983ea33ad561d78c8c91ffba7` and incoming parent is
  `aa45ea711f2b77c2a04319f9bc0fbc2abc482676`.
- The conflicts are additive imports in `QPBT/Combining/Lines.lean` and appended
  event records in this file. The resolution retains both import sets and both
  event sequences verbatim. All other staged incoming changes remain intact.
- The cited QPBT paper passages at lines 882-894, 950-963 and 1038-1116 were
  checked before resolving the imports. This recovery changes no theorem
  hypotheses, conclusions or proof bodies and introduces no proof holes.
  Existing author, fix and review histories and budgets remain unchanged.
- Pending-index and committed-object merge-loss checks, focused Lean checks,
  checked publication and canonical CI are the required validation sequence.
  Exact-head results and independent-review handoff are recorded in the session
  receipt. No child session, live-PR merge or daemon modification is part of
  this recovery. Lesson: combine additive conflict content without replacing
  either parent's mathematical contributions or historical records.
