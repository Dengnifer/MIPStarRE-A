---
title: "Issue 511: independent finite POVM obstruction (historical attempt)"
date: 2026-09-12
purpose: >
  Preserves verbatim the issue-511 second-attempt audit from PR #547, including its
  incomplete-target findings and cumulative costs, with the later status separated.
status: historical
track: qpbt
kind: preservation-audit
origin: "PR #547 head a4917f5da004a44085d4e910f36de023b6702445"
issue: "#511"
pr: "#547"
---
...
The historical record below is unchanged from PR #547 at the origin commit.
At published base `364cc2e1adf1ba963919d08e8d62826788ba24eb`,
`exists_extendedLinesWitness_established` and `exists_globalPairWitness` are
proved; the three unrestricted/printed-error assertions in `Apply.lean`
remain open. The finite obstruction is ported separately without changing
those statements or proof bodies. The old five-admission and pending-review
descriptions below describe the September 12 attempt, not this branch.
The recorded elapsed times are historical costs, not a restarted budget.
