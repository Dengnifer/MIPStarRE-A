---
title: "Direct-game error absorption: historical second attempt at issue #513"
date: 2026-09-12
purpose: >
  Preserve the second attempt's scalar-bound audit and cost accounting as
  historical evidence, not as a current assessment of the source theorem.
issue: "#513"
pr: "#545"
status: historical
---

**Historical status (2026-09-18).** The original 172-line record below is
preserved verbatim from PR #545 at `2f8f5cc4631db2db23f76513a2f7f56dffc8fa4f`.
Its proof-hole and remaining-construction claims describe the September 12
checkpoint, not the present proof status. The successor record
`audits/2026-09-14_issue-513_actual-error-absorption.md` documents the later
closure. The composition-compatibility record
`audits/2026-09-12_issue-513_composition-compatibility.md` also qualifies this
attempt: dispatcher session `prover-513-20260912-02` failed without a completed
final handoff. The original validation and costs below are historical claims;
this preservation does not independently revalidate them or reset any budget.
