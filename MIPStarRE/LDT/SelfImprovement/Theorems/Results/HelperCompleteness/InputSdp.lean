...
`1 - nu`. This is the input-consistency step in the completeness proof of
blueprint `lem:self-improvement-helper`. -/
...
`u`. This reindexing appears in the input-consistency step of the completeness
proof of blueprint `lem:self-improvement-helper`. -/
