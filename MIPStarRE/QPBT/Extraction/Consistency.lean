...
`lem:qld-construct-the-paulis-given-global-pair`. The joint source obligation
`exists_pulled_apart_consistency` is stated in `Extraction.Construction` for
`lem:qld-construct-the-paulis`, paper lines 1463-1480.
-/
