...
`def:dual-self-dual-normal-basis`, blueprint `ch11_qpbt_algebra.tex:243-245`,
...
`def:binary-representation`, blueprint `ch11_qpbt_algebra.tex:298-315`, paper
...
/-- Equation `eq:eq-mult`, blueprint `ch11_qpbt_algebra.tex:310-313`, paper
...
`ch11_qpbt_algebra.tex:298-315`, paper `04_preliminaries.tex:684-700`. -/
