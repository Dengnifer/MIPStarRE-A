...
`blueprint/src/chapter/ch12_qpbt_games.tex:599-629`, with paper origin
...
`ch12_qpbt_games.tex:599-604`, paper
...
`def:typed-cl-distributions`, blueprint `ch12_qpbt_games.tex:624-629`, paper
