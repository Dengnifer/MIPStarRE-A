...
`blueprint/src/chapter/ch12_qpbt_games.tex:601-631`, with paper origin
...
`ch12_qpbt_games.tex:601-606`, paper
...
`def:typed-cl-distributions`, blueprint `ch12_qpbt_games.tex:626-631`, paper
