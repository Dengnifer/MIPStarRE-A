...
`blueprint/src/chapter/ch12_qpbt_games.tex:1270-1300`, with paper origin
...
`ch12_qpbt_games.tex:1270-1275`, paper
...
`def:typed-cl-distributions`, blueprint `ch12_qpbt_games.tex:1295-1300`, paper
