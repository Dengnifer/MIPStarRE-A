...
`blueprint/src/chapter/ch12_qpbt_games.tex:1338-1382`, with paper origin
...
`ch12_qpbt_games.tex:1338-1343`, paper
...
`def:typed-cl-distributions`, blueprint `ch12_qpbt_games.tex:1377-1382`, paper
