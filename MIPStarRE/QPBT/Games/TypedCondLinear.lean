...
`blueprint/src/chapter/ch12_qpbt_games.tex:545-577`, with paper origin
...
`ch12_qpbt_games.tex:545-548`, paper
...
`def:typed-cl-distributions`, blueprint `ch12_qpbt_games.tex:568-577`, paper
