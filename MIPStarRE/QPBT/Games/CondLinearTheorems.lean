...
`lem:cl-dist-prod` in `blueprint/src/chapter/ch12_qpbt_games.tex:474-534`, with
paper origin
`references/qpbt-paper/05_conditionally_linear_functions.tex:150-364`.
-/
...
`ch12_qpbt_games.tex:474-490`, paper
...
used by `IsCondLinearOn`. Blueprint `ch12_qpbt_games.tex:474-490`, paper
`references/qpbt-paper/05_conditionally_linear_functions.tex:150-178`. -/
...
prefix decomposition of `lem:cl-kth`; blueprint `ch12_qpbt_games.tex:474-494`,
...
`ch12_qpbt_games.tex:515-526`, paper
...
`lem:cl-func-prod`; blueprint `ch12_qpbt_games.tex:511-526`, paper
`references/qpbt-paper/05_conditionally_linear_functions.tex:315-364`. -/
...
`ch12_qpbt_games.tex:528-534`, paper
