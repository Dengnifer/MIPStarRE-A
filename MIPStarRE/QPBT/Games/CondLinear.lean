...
map to that seed.  The inductive predicate records the recursive decomposition
into supported linear contributions.  Its support and evaluation properties
also describe how equal-level maps combine over pairwise disjoint coordinate
registers.
