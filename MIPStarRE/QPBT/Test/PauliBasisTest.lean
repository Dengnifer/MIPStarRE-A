...
one-level case of `def:cl-func`, blueprint `blueprint/src/chapter/ch12_qpbt_games.tex:1185-1195`,
...
blueprint `ch13_qpbt_test.tex:386-430`,
paper origin `references/qpbt-paper/08_classical_and_quantum_low_degree_tests.tex:964-1120`. -/
...
(`blueprint/src/chapter/ch13_qpbt_test.tex:386-430`; paper
`references/qpbt-paper/08_classical_and_quantum_low_degree_tests.tex:964-1120`).
-/
