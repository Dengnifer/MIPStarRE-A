...
-- Duplication with `map_uniformDistribution_seed` in
-- `MIPStarRE/QPBT/Test/LowDegreeGameTheorems.lean` is tracked by issue #204.
/-- The scalar-coordinate projection of a uniformly distributed ambient
