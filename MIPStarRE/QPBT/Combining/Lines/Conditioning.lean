...
The conditioned point-to-line estimates are re-exported from
`ConditionedPointLineMarginalDefect`, with their retained-mass denominators
and Z-then-X answer order unchanged.
