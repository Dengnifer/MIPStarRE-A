...
This note fixes terminology for a recurring failure mode in any
source-faithful formalization.  It complements the note-writing policy in
\path{docs/paper-gaps/policy.tex}; the project's own source-boundary proof
holes are tracked in its issue tracker.
...
source under \path{references/<key>-paper/}.  Its hypotheses and conclusion are
...
one formalization, projectivization and
