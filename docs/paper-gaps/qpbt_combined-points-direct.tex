...
The blueprint and the formal construction retain the source's combined-point
statement and both prove it by the direct argument above, with both ordered
products, all directed opposite placements, and the original expanded local
spaces.\footnote{The blueprint
