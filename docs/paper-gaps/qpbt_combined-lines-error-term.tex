...
\path{ExtendedLinesWitness} and the source-shaped declaration
...
convention that constants are absorbed into $\poly$.  Its proof is open as
well, so neither node carries a proof-completion mark.
