...
Two parts of the obstruction are independently verified in Lean: every
projective joint family admits some finite witness error, and a coefficient
...
perfect-strategy construction and the formal integration of the lower bound
remain to be supplied.}
The existing auxiliary signatures and their unfinished proofs are preserved
pending a separately scoped repair. A source-faithful existence proof must
construct polynomially controlled points internally and retain their error
