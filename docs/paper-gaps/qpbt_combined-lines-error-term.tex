...
by the existential declaration \path{exists_extendedLinesWitness}; no Lean
...
The printed error form itself. \path{exists_extendedLinesWitness} keeps the
printed expression and keeps an open proof; it is a source-gap declaration, not
a proof obligation of any Lean consumer, and it is neither marked proved nor
removed. The scalar obstruction \path{not_exists_combining_quarter_power_bound}
...
have different statuses.  The printed error form is still unproved: the proof of
\path{exists_extendedLinesWitness} is the tracked obligation, tracked by
\ghissue{598}, and
