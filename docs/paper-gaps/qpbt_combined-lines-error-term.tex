...
The existing unrestricted auxiliary signatures and their unfinished proofs
are preserved pending a separately scoped repair. A source-faithful existence
...
The declaration \path{exists_extendedLinesWitness} was a theorem whose
statement was the printed conclusion of the lemma and whose proof was an open
\path{sorry}.  That \path{sorry} was the last one in the combining track, and
it was not a proof obligation: no declaration depended on it, as a search over
the whole declaration set confirmed, and every consumer routes through
\path{exists_extendedLinesWitness_established}.
...
asserting it, so the development no longer claims the printed error form, and
it no longer carries proof debt for it either.  The printed sentence remains
