...
repair, the recommended candidate direction was direct index sampling, and
that direction is now carried out for the simultaneity parameter $k = 1$,
...
recovered on the compressed carriers from the point-agreement branch of the
