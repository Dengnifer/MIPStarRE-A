...
\begin{itemize}
  ...
  mixed consistency conclusions are formalized.  The remaining seed-indexed
  theorem requires a compression theorem for the global/global consistency
  conclusion.  Independently, discharging the original import obligations of
  ...
  global/global compression and the reduction to the tensor-code test.
...
\begin{enumerate}
  ...
  The seed-indexed source theorem remains open because the third,
  global/global consistency conclusion has not yet been compressed back from
  the correlated residue registers.
\end{enumerate}
...
open.  Both obligations are independent of the divisibility question and
remain open for the source's seed-indexed soundness theorem at every dimension
...
combining reduction.  This removes the divisibility obstruction for the
...
complement, the corresponding disagreements are $1$ and $1/2$.  No current
theorem transports this third relation, so a joint compression or another
argument controlling the global/global defect is the sole remaining transport
obligation in the direct-game route to the seed-indexed soundness theorem.
...
seed-indexed soundness theorem.  It already supplies the first two consistency
conclusions after correlated-residue compression; the third remains open as
described above.  Completing that transport must respect the subtree protocol
...
conclusions from this direct proof.  The seed-indexed soundness theorem remains
open specifically because the global/global consistency conclusion has not
been compressed.  Separately, the source-shaped polynomial-pair construction
