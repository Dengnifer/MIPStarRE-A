...
\begin{itemize}
  ...
  into the strategy's original zero-state padding is not proved.
  ...
  does not establish the source's padding assumption. The implementation in
...
Other QPBT source obligations are recorded in
\path{docs/paper-gaps/qpbt-gap-register.md}; its linearity row predates the
uniform-ancilla result recorded here.
