...
\begin{itemize}
  ...
  The scope correction is tracked in \ghissue{16}.
\end{itemize}
...
\cite[lines 1056--1095]{Ji2020MIPStar}.  It then uses the same character for
Fourier cancellation over a subspace at lines 1123--1140.  These assertions
depend on the characteristic $p$; they are not intrinsically binary.
