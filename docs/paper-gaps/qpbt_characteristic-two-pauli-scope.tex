...
\begin{itemize}
  ...
  \item \textbf{Estimated weight.} The completed extension is implemented in
  \path{MIPStarRE/QPBT/Algebra/PrimePauliBasis.lean}.  It formalizes the
...
register row therefore has terminal disposition \path{no-difference}: there is
no mathematical discrepancy in the domains, phases, hypotheses, or conclusions
of the source-facing statements.
