...
original POVM effects. Transferring both complete operator-family errors,
including any ground-slice leakage, and treating the full source error domain
remain open. The seed-indexed game correspondence remains a separate obligation
...
The unrestricted source theorem still requires the complete operator-family
transfer through the dilation, the full error domain, and the source-game
correspondence step; \path{pauli_soundness} remains open.
