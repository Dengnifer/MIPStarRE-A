...
concrete swap operators to local isometries is now justified by the
supplied-data transfer and the range-projection argument above; it does not
extend the construction to arbitrary strategies.
...
for supplied extraction data. The unrestricted source theorem still requires
the separate arbitrary-strategy and game-law steps.
