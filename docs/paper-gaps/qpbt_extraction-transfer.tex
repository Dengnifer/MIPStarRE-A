...
node Lemma~\path{lem:qld-unitary} accordingly carries no statement-level
formalization mark.  Apart from that hypothesis the conclusion matches the
Stage~4.2 extraction lemma, including the corrected numerical estimates; the
later passage to the isometries in the soundness theorem is not formalized, and
no declaration yet states that passage.
