...
without a witness premise.  The later passage from the concrete swap operators
to the isometries in the soundness theorem also remains unformalized and still
requires the range-projection argument of the preceding section.
...
final range-projection transfer remains separate and open.
