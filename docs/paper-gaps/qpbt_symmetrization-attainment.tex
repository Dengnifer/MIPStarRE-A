...
leave the source proof's attainment step unproved.  The public Lean statement
and its existing proof-gap marker are preserved in issue~\#524; any domain
correction requires a separate statement-integrity review.
...
The two Lean declarations follow the same separation.  The source-shaped
...
statement, while the source-labelled lemma keeps its source shape with the
attainment step an explicit, tracked proof obligation.  The 2026-09-18
realignment adds the approximate form as a proved Lean declaration under an
explicit nonempty-answer hypothesis and leaves the attainment assertion open
and tracked.  If a later
investigation settles the counterexample question for symmetric games with
nonempty answer alphabets, the statement should then be reclassified from
an unproved step to a documented
statement correction.

The exact current Lean domain has the additional empty-answer counterexample
above.  An unrestricted attainment theorem cannot discharge that statement;
the domain must first be reviewed separately.  No public statement is changed
by this note, and neither obstruction is discharged.
