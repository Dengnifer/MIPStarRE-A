...
\author{}
\date{2026-08-30, realignment section added 2026-09-18}
...
Following the disposition recorded for \ghissue{524}, the formalization keeps
...
Second, the approximate form of Section~2 above is now formalized and proved as
...
attainment step an explicit, tracked proof obligation.  The 2026-09-18 realignment adds the approximate form as a proved Lean declaration under an explicit nonempty-answer hypothesis and leaves the attainment assertion open and tracked.  If a later
investigation settles the counterexample question for symmetric games, the
statement should then be reclassified from an unproved step to a documented
