...
distance.  Under the operator-distance definition at lines~873--875, however,
the latter is $\tr_\rho((S-T)^2)$ rather than one half of that quantity.  Thus
...
$\draw$ while retaining the bound $\delta$.  The current formal theorem makes
the same choice.  Thus both carry the false normalization exhibited by the
counterexample.%
\footnote{See
