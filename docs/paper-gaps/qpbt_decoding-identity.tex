...
\begin{itemize}
  ...
  identity to every bounded individual-degree polynomial, although it holds
  only for polynomials in the image of the low-degree encoding.
...
the explicit hypothesis that $g$ belongs to the image of the encoding.
