...
\begin{itemize}
  ...
  variables at degree $d + 1$, which is not formalized.
  ...
  $m + k$ and at degree $d + 1$, a transfer of the success probability, and
  the extraction of $k$ polynomials from one polynomial by linearity:
  roughly 8--15 new definitions and 3000--5000 lines of formal proof.
