...
the general seed-indexed statement is now proved as
\leanid{exists\_ld\_soundness} in
\doclink{MIPStarRE/QPBT/Test/LowDegreeGameTheorems.lean}, by correlated seed
dilation, compression of the two mixed relations, and recovery of global
agreement as detailed in \cite{gap:qpbt_ld-dimension-divisibility};
...
form from the low individual degree theorem for every $k$. Correlated seed
compression and global recovery now also establish it for the seed-indexed
game for every $k$. The collision estimate used in that recovery selects a
coordinate where two already constructed tuples differ; it does not construct
simultaneous measurements from their coordinate marginals. The game
...
the directly indexed game, followed by correlated seed compression and global
consistency recovery for the seed-indexed game.
