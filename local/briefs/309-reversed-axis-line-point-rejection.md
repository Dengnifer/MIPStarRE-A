...
the forward axis-line/point transport from #305, and the diagonal-line/point
transport from #307. These references record theorem provenance rather than a
transient pull-request state. Existing #119 usage and the B8 budget of 13
attempts / 26509 seconds remain unchanged.
