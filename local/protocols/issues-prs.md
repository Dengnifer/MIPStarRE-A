...
transaction lock, missing owner-selected Space-capacity/external-zero gate, or
stale candidate is a HOLD reason; it is never silently converted into a merge
attempt. After a
