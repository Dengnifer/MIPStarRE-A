...
% Exemption: the node is not marked \leanok. The Lean `canonicalComplement` fixes the
...
% Exemption: no formalization mark, for the reason recorded above
...
% Exemption: the node is not marked \leanok. The two Lean declarations listed are the
