...
% Issue #676: the RREF/prefix-rank correspondence, cardinality, independence and
% register-subspace assertions are proved. This definition remains unmarked:
% executable Gaussian elimination and its polynomial arithmetic-operation bound
% remain obligations. Abstract RREF existence does not certify that algorithm.
% See audits/2026-09-22_issue-676-canonical-completion.md; no exemption is granted.
\begin{definition}[Canonical complement]\label{def:canonical-complement}
	\lean{MIPStarRE.QPBT.canonicalComplement}
  \lean{MIPStarRE.QPBT.exists_isReducedRowEchelon}
...
$i\in\{0,\ldots,m-1\}$, the finite index type $\mathrm{Fin}\,m$ in Lean.
