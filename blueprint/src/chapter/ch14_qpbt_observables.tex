...
\end{lemma}
\begin{proof}
	\uses{lem:qld-win-implications, lem:povm-to-obs, fact:data-processing, fact:agreement, lem:commutation-analysis, lem:ms-one-sided-anticommutation, fact:add-a-proj, def:strategy-observables}
	...
	for $j \in \{1,5\}$.  For each anticommuting $\omega$, the one-sided
	Magic Square consequence (Lemma~\ref{lem:ms-one-sided-anticommutation})
	applied with
