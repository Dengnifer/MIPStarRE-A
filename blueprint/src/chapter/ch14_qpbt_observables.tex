...
\begin{proof}
	\leanok
	\uses{fact:omega-anticomm-prob, fact:agreement, def:admissible, def:pauli-question-distribution, def:pauli-win-predicate, def:ld-win-predicate, def:ideg-deg-polynomials, def:consistency, lem:qld-reversed-consistency, lem:qld-distance-interchange}
