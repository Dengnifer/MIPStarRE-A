...
\begin{lemma}[Formalization support for Lemma~\ref{lem:ortho}]
	...
	\[
		d_\psi\bigl(P_a \ot \Id_{\mathsf{B}},\, Q_a \ot \Id_{\mathsf{B}}\bigr)^2
		\leq 220\,\delta^{1/4}\,.
	\]
\end{lemma}
\begin{proof}
	...
	\uses{lem:projective-low-rank-sum, lem:Q-completeness, lem:P-Q-approx,
		def:projective-P}
	Work with Alice's reduced state $\varphi$, for which the consistency
	hypothesis gives $\sum_a \bra{\varphi} Q_a - Q_a^2 \ket{\varphi} \leq 2\delta$.
	...
	complete on $\varphi$, and the operator $P$ of
