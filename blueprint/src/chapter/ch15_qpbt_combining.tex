...
% This source-shape node carries no formalization mark: it is \notready, and the
% established content is the restricted node lem:qld-xz-lines-restricted, whose Lean
% carrier is MIPStarRE.QPBT.restricted_lines_consistency_bound. The \lean entries below
% name the witness record and its existence statement for the declaration checker only.
