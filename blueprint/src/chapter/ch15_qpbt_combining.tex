...
\begin{proof}
	\leanok
	\uses{lem:qld-comm-cons, lem:twisted-commutation,
...
\begin{proof}
	...
	\uses{lem:qld-comm-cons, lem:expanded-point-field-commutation,
		lem:combined-point-distance-support, lem:ortho-explicit-constant,
		fact:add-a-proj, fact:triangle, def:expanded-point-measurement,
...
\begin{lemma}[Combined line measurement on the extended coordinates]
	...
	% form is tracked by GitHub issue 598. The line-point
...
\begin{remark}[The error term in the source proof of
	...
	obligation of any consumer: its declaration keeps an open proof, every
	formalized consumer uses the established form of
	Lemma~\ref{lem:qld-4-13-established}, and the gap is tracked by GitHub issue
	598 after the obstruction pull requests of the earlier issues closed those
	issues without proving the printed assertion.
\end{remark}
