...
Lemma~\ref{lem:combined-lines-given-points} to that same family. The direct
subline witness of Lemma~\ref{lem:direct-subline-witness-exists} supplies the
conditional extended-line measurement. Its axis-degree theorem gives the
support field, while the extended-overlap comparison and
...
into $m\cdot\poly(\eps,md/q)$. This proves the stated directly indexed
auxiliary. Its comparison with the printed source formulation remains subject
