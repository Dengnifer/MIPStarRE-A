...
\begin{proof}
	...
	self-consistency bounds each completed point-to-line marginal defect by
	...
	the root bound therefore gives conditional collision probability at
	most $md/q$. Both marginal defects under the restricted law are at
	most $\Delta/r$.
	...
	\]
	Take the minimum with the independent unit bound. Since
	$1/2\le r\le1$, $md\ge1$, and $\delta_Q$ is polynomially small,
	the result has a uniform bound of the required corrected sum form.
