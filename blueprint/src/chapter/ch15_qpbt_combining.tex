...
\begin{lemma}[Formalization support: a uniform point under the directly indexed law]
	...
	\uses{lem:qld-sublines, def:line-point-dist, def:line-representative,
		def:combine-map}
	For the directly indexed subline law represented by
	\texttt{SubLineWitness}, a uniform affine parameter on the sampled extended line gives a uniform
...
\begin{lemma}[Formalization support: real-part replacement under the directly indexed law]
	...
	Let $D_{\mathrm{dir}}$ be any directly indexed subline law represented by
	\texttt{SubLineWitness}, and let $Q,T$ satisfy the joint point and line
	witness properties with errors $\delta_Q,\delta_P$. Write
...
\begin{lemma}[Formalization support: the concrete X deficit under the directly indexed law]
	...
	Let $D_{\mathrm{dir}}$ be a directly indexed subline law represented by
	\texttt{SubLineWitness}. For the concrete X-Z-X measurement, let
...
\begin{lemma}[Formalization support: the real Z overlap under the directly indexed law]
	...
	Let $Q,T$ satisfy the joint point and line witness properties with errors
	$\delta_Q,\delta_P$, and let $D_{\mathrm{dir}}$ be a directly indexed
	subline law represented by \texttt{SubLineWitness}. If $B_Z$ is the
...
\begin{proof}
	...
	nonnegative overlap deficit; taking a square root gives the displayed bound.
\end{proof}
...
\begin{proof}
	...
	proof over the source law remains open; the real-part auxiliary below
