...
\begin{lemma}[Restriction of a given line consistency bound]
	...
	\{\mathrm{ALine},\mathrm{DLine}\}$ and indices $i,j\in\{0,\dots,m-1\}$,
	\begin{equation}
...
\begin{theorem}[Formalization support for the sub-line distribution]
	...
	choose a kind and an index $j\in\{0,\dots,n-1\}$
	...
	\begin{enumerate}
		...
		$\{\mathrm{ALine},\mathrm{DLine}\}\times\{0,\dots,m-1\}^2$,
...
\begin{proof}
	...
	fiber of $\bar\chi$. In the axis case use the chosen coordinate direction.
