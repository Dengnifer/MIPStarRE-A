...
\begin{lemma}[Formalization support: construction of the directly indexed sub-line law]
	...
	\lean{MIPStarRE.QPBT.exists_raw_of_mem_subLineDist_support}
...
conditional extended-line measurement. Its axis-degree theorem proves that no
outcome above degree $d$ occurs on an axis-parallel extended line, while the
extended-overlap comparison and
