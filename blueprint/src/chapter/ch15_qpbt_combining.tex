...
\begin{lemma}[Consistency of the constructed paired-line measurement]
	...
	This is a Lean-only construction theorem. Fix a polynomially small
...
\begin{proof}
	...
	constructed $X$-$Z$-$X$ line measurement. The real-part overlap estimates
	for both opposite placements give a bound of the form
	$m \cdot \poly(\eps, md/q)$, with the unit bound on consistency handling
	large errors. This proves the stated directly indexed auxiliary.
