...
\begin{proof}
	\leanok
	\uses{lem:binary-measurement-distance, lem:boolean-fourier-transform,
		lem:naimark-helper}
...
\begin{remark}[Normalization of the distance in the linearity conclusion]
	...
	As printed in \cite{Natarajan2017Linearity} and quoted in
	\cite{Ji2020MIPStar}, the conclusion of the quantum linearity theorem
	bounds the squared state-dependent operator distance $d_{\rho'}^2$ by
	$\delta$. The calculation behind that bound in
	...
	identifies the two quantities; the identification loses that factor.
	What the Fourier argument proves is the bound $\delta$ for the squared
	measurement distance, equivalently $2\delta$ for the squared operator
	...
	and Theorem~\ref{thm:linearity} is stated with the corrected bounds:
	$2\delta$ for the squared operator distance and $\delta$ for the squared
