...
\begin{proof}
	...
	characters of $\F_q$ are orthogonal, so Parseval's identity rewrites the
	average of the squared norms of these combinations as the average of the
	squared norms of the individual observable commutators, with no factor
	depending on $q$. That average is the twisted-commutator average
