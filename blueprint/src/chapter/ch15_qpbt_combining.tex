...
\begin{definition}[Restricted line distributions]
	...
	and the following mixture estimates. Index $i$ here denotes coordinate
	$i+1$ in the one-based notation of \cite{Ji2020MIPStar}; likewise
	$\chi(s)$ here is one less than the paper's index function.
	...
	(The function $\chi$ is the one used in
