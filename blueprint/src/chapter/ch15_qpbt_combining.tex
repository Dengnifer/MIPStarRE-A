...
\begin{lemma}[Formalization support: construction of the directly indexed sub-line law]
	...
	The concrete law $D_{\mathrm{dir}}$ is the equal mixture of the axis and
	...
	Every triple in the support is produced by auxiliary point, direction, and
	seed data from one of the two branches. Such a triple satisfies incidence of
	the two projected points with their source lines, the affine compatibility
	relations for both projections, and closure of both source lines under an
