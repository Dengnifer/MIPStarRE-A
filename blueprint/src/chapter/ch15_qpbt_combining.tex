...
\begin{lemma}[Formalization support: consistency of the sandwich point POVM]
	...
	\[
		\sum_{a,b} \bra\psi R^1_{a,b} R^2_{a,b} \ket\psi
		= \lVert\psi\rVert^2
	...
	and consequently
	\[
		\lVert\psi\rVert^2 - \sum_{a,b} \bra\psi R^1_{a,b} R^2_{a,b} \ket\psi
...
\begin{lemma}[Formalization support for the algebra of register placements]
	...
	$p_1$ and every $B$ on the side of $p_2$. Together with the identity
	above this makes each placement a unital $*$-homomorphism, so it carries a
	projector to a contraction.
\end{lemma}
\begin{proof}
	\leanok
	\uses{def:symmetric-equivalents, def:povm-conventions}
	...
	sit in different factors of one bipartition.
\end{proof}
