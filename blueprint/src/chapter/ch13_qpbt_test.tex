...
\begin{remark}[Relation to the low individual degree test of Chapter~\ref{chap:test}]\label{rem:ld-soundness-provider}
	Theorem~\ref{lem:ld-soundness} is proved for every positive simultaneity
	parameter $k$ on the original seed-indexed domain $m\mid q$. Its
	formalized proof, recorded in Theorem~\ref{lem:ld-soundness-formalized},
	...
	therefore distinguishes the established soundness statement from this
	unverified source derivation. It also distinguishes both from the
