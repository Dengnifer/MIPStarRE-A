...
\begin{proof}
	\leanok
	\uses{def:cl-dist, def:ld-question-distribution, def:line-representative, lem:line-rep-incidence}
...
\begin{definition}[Question distribution of the Pauli basis test]\label{def:pauli-question-distribution}
	...
	\lean{MIPStarRE.QPBT.isCondLinear_pauliCL, MIPStarRE.QPBT.pauliEdges}
	...
	The displayed level of each individual map $L_t$ is proved. These assertions do not yet provide one common level for the family, and the identification of this sampler with the general typed CL construction remains open; both assertions are stated separately in Lemma~\ref{lem:pauli-question-typed-cl}.
\end{definition}
