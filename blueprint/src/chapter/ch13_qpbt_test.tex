...
\begin{proof}
	\leanok
	\uses{lem:direct-ld-simultaneous-single, lem:direct-ld-residue-compression, lem:sandwich-codeword-defect, lem:direct-ld-polynomial-agreement, lem:ld-point-agreement, lem:ld-transport-absorption, lem:ld-scalar-square-root}
