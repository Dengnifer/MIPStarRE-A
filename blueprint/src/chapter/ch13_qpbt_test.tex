...
The formal witness retains the two Pauli trace measurements for
$(\mathsf{Pair},W)$ also when $\gamma\neq 0$, rather than replacing these
inactive measurements by the trivial ones in the source. The commutation and
$\mathsf{Pair}$-consistency checks accept automatically in this case; the
retained measurements are still consistent coarse-grainings of a single Pauli
basis, and the $\mathsf{Pair}$ measurement is trivial. Thus this choice preserves
the SPCC and value-one conclusions of the lemma.
