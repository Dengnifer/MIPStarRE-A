...
\begin{lemma}[Consistency and self-consistency of the pulled-apart measurements]\label{lem:qld-construct-the-paulis}
	...
	Lean proof obtains the full-domain witness from Lemma~\ref{lem:qld-4-7},
	applies the three conditional estimates below to that same witness, and
	enlarges their constants to one common maximum. The composition history and
	separate extraction-transfer corrections are recorded in
