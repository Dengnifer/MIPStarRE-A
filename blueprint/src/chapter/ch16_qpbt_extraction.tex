...
\begin{lemma}[Formalization support for the transport of states, operators and distances]\label{lem:extraction-register-transport-support}
	...
	\leanok
	\uses{def:extraction-epr-first-order, def:povm-distance, def:EPR}
...
\begin{proof}
	\leanok
	\uses{def:extraction-epr-first-order, def:expanded-state}
