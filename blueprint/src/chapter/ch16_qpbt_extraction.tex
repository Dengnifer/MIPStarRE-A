...
\begin{remark}[Conditional formalization support for Lemma~\ref{lem:qld-unitary}]
	...
	This conditional assertion is recorded by the Lean declaration
	\texttt{MIPStarRE.QPBT.exists\_extractionWitness\_ofGlobalPairWitness}; it is
	not a named statement of the paper. It is the conditional, given-witness form
