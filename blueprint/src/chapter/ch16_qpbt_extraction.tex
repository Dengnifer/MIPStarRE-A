...
\begin{theorem}[EPR projection estimates]\label{thm:qld-epr-projection-estimates}
	...
	\]
	Then $H_XH_Z=\ketbra{E}{E}$. Let $R$ be an auxiliary register and
	...
	\]
	then, writing $\Pi=\Id_R\ot\ketbra{E}{E}$, one has
	\[
...
\begin{proof}
	...
	labels. Averaging the simultaneous shifts gives $H_XH_Z=\ketbra{E}{E}$.
