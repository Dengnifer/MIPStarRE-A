...
\begin{theorem}[Questionwise Pauli Naimark reduction]
  ...
  \lean{MIPStarRE.QPBT.pauliNaimarkEmbeddingB}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_isProjective}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_value}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_state}
  \lean{MIPStarRE.QPBT.pauliNaimarkSetting}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_compressA}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_compressB}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_pauli_compressA}
  \lean{MIPStarRE.QPBT.pauliNaimarkStrategy_pauli_compressB}
  \lean{MIPStarRE.QPBT.pauliNaimarkWitness}
  \lean{MIPStarRE.QPBT.pauli_naimark_witness_state_eq}
  \lean{MIPStarRE.QPBT.pauli_naimark_witness_state_distance_eq}
  \leanok
  \uses{thm:naimark}
...
\begin{theorem}[Pauli operator-family transfer through Naimark compression]
  ...
  \lean{MIPStarRE.QPBT.pauli_naimark_operator_distanceB_le}
  \leanok
