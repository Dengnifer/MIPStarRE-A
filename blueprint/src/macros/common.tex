...
% Machine-readable nodes for formalization results that are not paper statements.
% Registered as a dependency-graph node type by the thms= option in web.tex and
% scanned by scripts/audit_green_node_integrity.py; keep the three in step.
\newtheorem{example}[theorem]{Formalization support}
